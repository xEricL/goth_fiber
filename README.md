# Goth-Fiber: Multi-Provider Authentication for Go [![GoDoc](https://godoc.org/github.com/xEricL/goth_fiber?status.svg)](https://godoc.org/github.com/shareed2k/goth_fiber)
...
```text
$ go get github.com/xEricL/goth_fiber
```
...
```text
$ git clone git@github.com/xEricL/goth_fiber.git
```
